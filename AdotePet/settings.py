"""
Django settings for AdotePet project.
...
SECRET_KEY = 'django-insecure-!)xa53axr#5jgag1$-jrds+6oijcs-)uq8ou4gjzds8c231$0v'
...
WSGI_APPLICATION = 'AdotePet.wsgi.application'
