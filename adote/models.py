...
class Local(models.Model):
    ...
    estado = models.CharField(max_length=50)  # Corrigido de maxlength para max_length
...
class InteresseAdocao(models.Model):
    ...
    """
    adotante = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='interesses')
